...
def s3_client_connect(access_key, secret_key, url):
    return(boto3.client('s3', aws_access_key_id = access_key, aws_secret_access_key = secret_key, endpoint_url = url, verify=False))

def s3_connect(access_key, secret_key, url):
    return (boto3.resource('s3', aws_access_key_id = access_key, aws_secret_access_key = secret_key, endpoint_url = url, verify=False))
